...
Features:
  ...
  Develop: ["Base", "MySQL", "Option", "Sms", "AliOSS", "LoggerFile"]
  Demo: ["Base", "MySQL", "Option", "Sms", "MinIO", "LoggerFile"]
  Slim: ["Base", "Sqlite3", "LocalOSS", "LoggerFile"]
  Base: ["Meili", "Redis", "Alipay",]
...
这里 `Default`套件 代表的意思是： 使用`Base/Option` 中的功能，外加 `MySQL/LocalOSS/LoggerFile`功能，也就是说开启了`Meili/Redis/Alipay/SimpleCacheIndex/MySQL/LocalOSS/LoggerFile` 7项功能；
`Develop`套件依例类推。 
...
Features:
  Default: ["Sqlite3", "Meili", "LocalOSS",  "BigCacheIndex", "Web"]
WebServer: # Web服务
  HttpIp: 0.0.0.0
  HttpPort: 8010
  ReadTimeout: 60
...
Features:
  Default: ["Sqlite3", "Meili", "LocalOSS",  "BigCacheIndex", "Web", "Admin", "Bot"]
WebServer: # Web服务
  HttpIp: 0.0.0.0
  HttpPort: 8010
  ReadTimeout: 60
